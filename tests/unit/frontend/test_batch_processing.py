...
class TestMoveToBatch:
    ...
    # NOTE: Tests for auto_process, tier passing, timeout handling, and HTTP error handling
    # have been removed because pipeline orchestration has moved to the batch page frontend.
    # Flask endpoint now only updates MongoDB status and returns job IDs for frontend to trigger.
