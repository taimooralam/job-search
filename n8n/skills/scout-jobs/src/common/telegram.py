...
def notify_cron_ran(script_name: str, duration_s: float, summary: str) -> bool:
    """Send a compact notification when a cron job completes."""
    msg = f"\U0001f3dc\ufe0f <b>{script_name}</b> ({duration_s:.0f}s)\n{summary}"
